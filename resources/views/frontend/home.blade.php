...
<div class="slider-section section">
    <div class="slide-item bg-parallax" data-bg-image="{{ asset('frontend/assets/images/slider/slider-1.jpg') }}" data-overlay="50">
        <div class="container">
    ...
    <div class="container">
        ...
        <div class="job-list-wrap">
            ...
            <a href="job-single.html" class="job-list row">
                ...
                <div class="salary-type col-auto order-sm-3">
                    <span class="salary-range">$5000 - $8000</span>
                    <span class="badge bg-danger">Freelance</span>
                </div>
                <div class="content col">
                    <h6 class="title">Full Stack Backend Developer</h6>
                    <ul class="meta">
        ...
        <div class="company-slider row">
            ...
            <div class="col">
                <a href="company-single.html" class="feature-company">
                    <span class="company-logo"><img src="assets/images/companies/company-1.png"
                            alt="company-1"></span>
            ...
            <div class="col">
                <a href="company-single.html" class="feature-company">
                    <span class="company-logo"><img src="assets/images/companies/company-2.png"
                            alt="company-1"></span>
            ...
            <div class="col">
                <a href="company-single.html" class="feature-company">
                    <span class="company-logo"><img src="assets/images/companies/company-3.png"
                            alt="company-1"></span>
            ...
            <div class="col">
                <a href="company-single.html" class="feature-company">
                    <span class="company-logo"><img src="assets/images/companies/company-4.png"
                            alt="company-1"></span>
            ...
            <div class="col">
                <a href="company-single.html" class="feature-company">
                    <span class="company-logo"><img src="assets/images/companies/company-8.png"
                            alt="company-1"></span>
            ...
            <div class="col">
                <a href="company-single.html" class="feature-company">
                    <span class="company-logo"><img src="assets/images/companies/company-9.png"
                            alt="company-1"></span>
            ...
            <div class="col">
                <a href="company-single.html" class="feature-company">
                    <span class="company-logo"><img src="assets/images/companies/company-10.png"
    ...
    <div class="container">
        ...
        <div class="blog-slider slick-space">
            ...
            <div class="blog">
                ...
                <div class="content">
                    <h6 class="title"><a href="blog-single.html">The Top 5 Job Interview Questions For IT
                            Professional</a></h6>
                    <ul class="meta">
                        <li>Posted on 25 Jan, 2023</li>
                        <li><a href="#">3 Comments</a></li>
                    </ul>
                    <div class="desc">
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Praesentium fugiat fugit
                            voluptates ut rem vitae.</p>
                    </div>
            ...
            <div class="blog">
                ...
                <div class="content">
                    <h6 class="title"><a href="blog-single.html">7 Careers To Consider If You Love Traveling</a>
                    </h6>
                    <ul class="meta">
                        <li>Posted on 25 Jan, 2023</li>
                        <li><a href="#">3 Comments</a></li>
            ...
            <div class="blog">
                ...
                <div class="content">
                    <h6 class="title"><a href="blog-single.html">When the Perfect Candidate Turns Out To Be an
                            Imperfect Fit</a></h6>
                    <ul class="meta">
                        <li>Posted on 25 Jan, 2023</li>
                        <li><a href="#">3 Comments</a></li>
