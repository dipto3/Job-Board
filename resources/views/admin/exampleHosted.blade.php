            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        ...
                        <span class="text-muted">{{ $cart->package->price }}</span>
                    </li>
                   
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Total (BDT)</span>
                        <strong>{{ $cart->package->price }} TK</strong>
                    </li>
                </ul>
            </div>
                ...
                <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="customer_mobile" class="form-control" id="mobile"
                                placeholder="Mobile" value="{{ $cart->user->companyInfo->contract_number }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="customer_email" class="form-control" id="email"
                            placeholder="you@example.com" value="{{ $cart->user->email }}" required>
                        <div class="invalid-feedback">
